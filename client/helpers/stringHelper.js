...
/*
 * isEmpty
 * Will return true if parameter str is:
 *  null
 *  undefinded
 *  NaN
 *  empty String("")
...
this.isValidAdmNumber = (value) => {
    let letters = value.substr(0, 3).toUpperCase();
    return (letters === 'ADM' && value.length === 7);
};
...
this.isValidString = function(value, min_length) {
