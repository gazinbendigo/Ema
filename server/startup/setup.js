...
Meteor.startup(function(){
    ...
    if (Meteor.users.find().fetch().length === 0) {
        ...
        var users = [
            ...
            {firstName: "James", lastName: "Henry", username: "adm1122", password: "12345678", email:"aUser2@hotmail.com",    groups: {OTHER: [ApplicationRoles.properties[ApplicationRoles.Installer].group], DEV: []}},
            {firstName: "Joe", lastName: "Brown", username: "adm1133", password: "12345678", email:"User3@hotmail.com",       groups: {OTHER: [ApplicationRoles.properties[ApplicationRoles.Analyst].group], DEV: [ApplicationRoles.properties[ApplicationRoles.SuperUser].group]}},
            {firstName: "Fred", lastName: "Flintstone", username: "adm1144", password: "12345678", email:"User4@hotmail.com", groups: {OTHER: [ApplicationRoles.properties[ApplicationRoles.Analyst].group], DEV: [ApplicationRoles.properties[ApplicationRoles.SuperUser].group, ApplicationRoles.properties[ApplicationRoles.Administrator].group]}},
